                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center p-3 bg-gray-50 rounded-lg">
                      ...
                      <span className="text-gray-900">{userData?.isVerified ? userData?.email : "guest12@gmail.com"}</span>
                      {userData?.isVerified&&
              ...
              <div className="card p-6">
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full bg-red-50 hover:bg-red-100 text-red-700 font-semibold py-3 px-4 rounded-lg border border-red-200 transition-colors duration-200 flex items-center justify-center"
                  >
